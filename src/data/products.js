const products = [
  ...
  },
  {
    ...
    coverImage: "/images/products/green&white-golfer.pn",
    sizes: ["S", "M", "L", "XL"],
    colors: [
  ...
  },
  {
    ...
    subcategory: "shirts",
    price: 1299,
    description: "Relaxed oversized fit. Double chest pockets. Clean button-up front.",
    coverImage: "/images/products/white-ss-shirt-cover.png",
    sizes: ["S", "M", "L", "XL"],
    colors: [
      { name: "Navy", hex: "#1B2838", image: "/images/products/navy-ss-shirt.png" },
      { name: "Crème", hex: "#FAF7F2", image: "/images/products/creme-ss-shirt.png" },
      { name: "Black", hex: "#1A1A1A", image: "/images/products/black-ss-shirt.png" },
      { name: "White", hex: "#FFFFFF", image: "/images/products/white-ss-shirt.png" }
    ],
    featured: true
  },
  {
  ...
  },
  {
    ...
    sizes: ["28", "30", "32", "34", "36"],
    colors: [
      { name: "Black", hex: "#1A1A1A", image: "/images/products/black-baggy-formal-pants.png" },
  ...
  },
  {
    ...
    coverImage: "/images/products/military-cargopants.png",
    sizes: ["28", "30", "32", "34", "36"],
    colors: [
  ...
  },
  {
    ...
    coverImage: "/images/products/brown-hoodie.png",
    sizes: ["S", "M", "L", "XL"],
    colors: [
  ...
  // ==================== ACCESSORIES ====================
  {
    ...
    coverImage: "/images/products/cover-beanie.png",
    sizes: ["One Size"],
    colors: [
      { name: "Crème", hex: "#FAF7F2", image: "/images/products/creme-beanie.png" },
      { name: "Black Pattern", hex: "#1A1A1A", image: "/images/products/black-beanie1.png" },
      { name: "Avocado 1", hex: "#556B2F", image: "/images/products/avocado-beanie1.png" },
      { name: "Avocado 2", hex: "#556B2F", image: "/images/products/avocado-beanie2.png" },
      { name: "Bronze", hex: "#B87333", image: "/images/products/bronze-beanie.png" },
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "White", hex: "#FFFFFF", image: "/images/products/white-bucket-hat.png" },
      ...
      { name: "Bronze", hex: "#B87333", image: "/images/products/bronze-bucket-hat.png" }
    ],
    featured: false
  },
  {
